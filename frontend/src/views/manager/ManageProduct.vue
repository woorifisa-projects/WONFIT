...
const loadData = async (tab) => {
  try {
    ...
    switch (tab) {
      case "예금":
        endpoint = "https://back.wonfit.site/product/deposit"; // 예금 데이터를 가져오는 엔드포인트
        break;
      case "적금":
        endpoint = "https://back.wonfit.site/product/savings"; // 적금 데이터를 가져오는 엔드포인트
        break;
      case "펀드":
        endpoint = "https://back.wonfit.site/product/fund"; // 펀드 데이터를 가져오는 엔드포인트
        break;
      case "대출":
      ...
      //   break;
      // case "적금":
      //   endpoint = "http://localhost:8080/product/savings"; // 적금 데이터를 가져오는 엔드포인트
      //   break;
      // case "펀드":
      //   endpoint = "http://localhost:8080/product/fund"; // 펀드 데이터를 가져오는 엔드포인트
      //   break;
      // case "대출":
      //   endpoint = "http://localhost:8080/product/loan"; // 대출 데이터를 가져오는 엔드포인트
      //   break;
