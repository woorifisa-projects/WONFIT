            ...
            <v-row>
              ...
              <v-col cols="8">
                <v-text-field
                  ...
                  placeholder="입금하고자하는 금액을 입력해주세요."
                  :rules="[rules.onlyNumbers, rules.maxDeposit]"
                  :hint="`최대 납입 금액은 ${maxDeposit}원 입니다.`"
                  style="width: 300px; margin-left: 22px"
                  single-line
                  variant="outlined"
                >
...
const isAllChecked = computed(() => {
  return (
    ...
    subSavings.value >= 10000 &&
    monthlyCharge.value <= maxDeposit.value &&
    (password.value && subSavings.value && monthlyCharge.value) !== String &&
    expirePeriod.value &&
