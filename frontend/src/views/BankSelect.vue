    ...
    >
      ...
      >
        ...
        <div class="image-grid bank-name">
          <div class="grid-row">
            <div class="grid-item">
              <img src="@/assets/kookmin.png" />
              <p>국민은행</p>
            </div>
            <div class="grid-item">
              <img src="@/assets/woori.png" />
              <p>우리은행</p>
            </div>
            <div class="grid-item">
          ...
          <div class="grid-row">
            ...
            <div class="grid-item">
              <img src="@/assets/toss.png" />
              <p>토스뱅크</p>
            </div>
            <div class="grid-item">
              <img src="@/assets/kbank.png" />
              <p>케이뱅크</p>
            </div>
          </div>
          <div class="grid-row">
            <div class="grid-item">
              <img src="@/assets/nonghyup.png" />
              <p>농협은행</p>
            </div>
            <div class="grid-item">
              <img src="@/assets/ibk.png" />
              <p>IBK기업은행</p>
            </div>
            <div class="grid-item">
      ...
      >
        ...
        <v-radio-group inline style="margin: 10px">
          <v-radio label="20대 이하" value="1"></v-radio>
          <v-radio label="30대" value="2"></v-radio>
          <v-radio label="40대" value="3"></v-radio>
          <v-radio label="50대" value="4"></v-radio>
          <v-radio label="60대 이상" value="5"></v-radio>
        </v-radio-group>
      </div>
