  ...
  data() {
    return {
      quizInfo: [
        ...
        {
          answerNum: "6",
          answerAsk: "Q6.새로 의자를 사야하는데 오래 앉아있어야 하는 직업인 당신! 어떤 의자를 살거냐면..",
          answerChoice: [
        ...
        {
          answerNum: "7",
          answerAsk: "Q7.친구들 만날 때 돈도 못 쓰고.. 적금이 드디어 만기다! 근데 이자가.. 작고 귀엽다. 이자를 보니 이런 생각이 드네",
          answerChoice: [
        ...
        {
          answerNum: "8",
          answerAsk: "Q8.친구랑 여행을 가려고 했는데 계획도 오케이 예약도 오케이 근데 다른 여행지도 재밌어 보이는데 이걸 어쩌지?",
          answerChoice: [
