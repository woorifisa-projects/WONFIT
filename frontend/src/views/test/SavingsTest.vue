...
export default {
  data() {
    return {
      quizInfo: [
        {
          answerNum: "1",
          answerAsk: "Q1.투자에 대한 지식수준이 어느 정도냐는 질문을 받았습니다 당신의 대답은?",
          answerChoice: [
            {
        ...
        {
          answerNum: "2",
          answerAsk: "Q2.내 연간 소득은 어느 정도 냐면~",
          answerChoice: [
            { text: "1. 3천만원 이하", score: 3 },
            { text: "2. 5천만원 이하", score: 2 },
            { text: "3. 5천만원 이상", score: 1 },
          ],
        },
        {
          answerNum: "3",
          answerAsk: "Q3. 더 와닿는 말은?",
          answerChoice: [
            { text: "1. 공포에 사서 환희에 팔아라", score: 3 },
            { text: "2. 잃지 않는 승부를 하라", score: 2 },
            { text: "3. 밀짚모자는 겨울에 사라", score: 1 },
          ],
        },
        {
          answerNum: "4",
          answerAsk: "Q4.붕어빵 먹을 때 가장 먼저 먹는 부위는?",
          answerChoice: [
        ...
        {
          answerNum: "5",
          answerAsk: "Q5.얏호~ 급여 들어왔다! 근데 내 급여는 말이야",
          answerChoice: [
        ...
        },
        {
          answerNum: "6",
          answerAsk:
            "Q6.새로 의자를 사야하는데 오래 앉아있어야 하는 직업인 당신! 어떤 의자를 살거냐면..",
          answerChoice: [
            { text: "1. 꼼꼼하게 조사해서 가성비가 좋은게 좋지 역시", score: 3 },
            { text: "2. 그냥 비싼게 최고야 예산만큼 비싼거 사자!", score: 2 },
        ...
        },
        {
          answerNum: "7",
          answerAsk:
            "Q7.친구들 만날 때 돈도 못 쓰고.. 적금이 드디어 만기다! 근데 이자가.. 작고 귀엽다. 이자를 보니 이런 생각이 드네",
          answerChoice: [
        ...
        },
        {
          answerNum: "8",
          answerAsk:
            "Q8.친구랑 여행을 가려고 했는데 계획도 오케이 예약도 오케이 근데 다른 여행지도 재밌어 보이는데 이걸 어쩌지?",
          answerChoice: [
        ...
        {
          answerNum: "9",
          answerAsk: "Q9.헤드헌터에게 세가지 제안이 왔다 어디 회사로 가야할까",
          answerChoice: [
            { text: "1. 성과도 좋고 탄탄한 회사", score: 2 },
            { text: "2. 잘 맞고 배울 수 있을 것 같은 회사", score: 3 },
            { text: "3. 워라밸이 좋은 후기가 좋은 회사", score: 1 },
          ],
        },
        {
          answerNum: "10",
          answerAsk: "Q10.투자를 하게 되면 원하는 수익과 감내할 수 있는 손실 수준은?",
          answerChoice: [
  ...
  methods: {
    async navigateToRecommendPage() {
      ...
      await axios
        .post(
          "http://13.125.155.169:8080/member/recommend/product",
          {
            productType: "savings",
