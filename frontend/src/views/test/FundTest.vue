  ...
  data() {
    return {
      quizInfo: [
        {
          answerNum: "1",
          answerAsk: "Q1.내가 부자가 되는 가장 확실한 방법은?",
          answerChoice: [
            {
              text: "1. 리스크는 있지만 다양한 자산에 투자 하는 것 가상화폐,NFT 가 뜬다니깐!",
              score: 3,
            },
            { text: "2. 적금,펀드 같은 상품으로 안정적으로 열심히 모아야지", score: 1 },
            { text: "3. 돈을 안쓰면 되지~ 일만 열심히 하면 돼", score: 2 },
          ],
        },
        {
          answerNum: "2",
