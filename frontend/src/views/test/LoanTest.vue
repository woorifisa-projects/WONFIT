  ...
  data() {
    return {
      quizInfo: [
        {
          answerNum: "1",
          answerAsk: "Q1.대출을 받으려는 목적은?",
          answerChoice: [
            { text: "1. 전세나 집 계약 해야 할거 같은데", score: 2 },
            { text: "2. 큰 돈은 아닌데 잠깐 필요할거 같아", score: 1 },
            { text: "3. 크게 돈 들어갈 일이 있어 ", score: 3 }
          ],
        },
        {
          answerNum: "2",
          answerAsk: "Q2.얏호~ 급여 들어왔다! 근데 내 급여는 말이야",
          answerChoice: [
        ...
        {
          answerNum: "3",
          answerAsk: "Q3.투자에 대한 지식수준이 어느 정도냐는 질문을 받았습니다 당신의 대답은?",
          answerChoice: [
        ...
        {
          answerNum: "4",
          answerAsk: "Q4.내 연간 소득은 어느 정도 냐면~",
          answerChoice: [
        ...
        },
        {
          ...
          answerChoice: [
            { text: "1. 에휴..다음 적금은 괜찮으려나 다음 적금이나 들자", score: 3 },
            { text: "2. 오 그래도 모은돈은 좀 되는데..? 적금 말고 투자나 해봐?", score: 3 },
            { text: "3. 일단 이자로 핸드폰 바꿔야지", score: 3 }
          ],
        },
        {
          answerNum: "7",
