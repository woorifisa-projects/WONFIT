  ...
  <div style="margin-top: 50px">
    <v-card class="mx-auto pa-12 pb-8" elevation="8" max-width="448" rounded="lg">
      ...
      <v-card-text class="text-center">
        <a class="text-blue text-decoration-none" href="#" rel="noopener noreferrer" @click="goToSignup">
...
const login = async () => {
  try {
    ...
    const response = await axios.post("http://localhost:8080/wonfit/login", requestBody, { withCredentials: true });
