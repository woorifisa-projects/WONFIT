...
const navigateToIncomeAnalysisPage = async () => {
  ...
  VueCookies.set('selectedBank', JSON.stringify(selectedBank.value)); // 결과보기 버튼을 클릭할 때 쿠키에 selectedBank 저장
  console.log(VueCookies.get('selectedBank')); // 콘솔에서 쿠키 값을 확인합니다.
